...
public class ButtonChecker : MonoBehaviour
{
    ...
    public void RotX()
    {
        ...
        batch.AddTask(new RotationTask(1, 90.0f, new Vector3(1, 0, 0)));
    ...
    public void RotY()
    {
        ...
        batch.AddTask(new RotationTask(1, 60.0f, new Vector3(0, 1, 0)));
        batch.AddTask(new RotationTask(2, 90.0f, new Vector3(0, 1, 0)));
    ...
    public void RotZ()
    {
        ...
        batch.AddTask(new RotationTask(1, 60.0f, new Vector3(0, 0, 1)));
        batch.AddTask(new RotationTask(2, 90.0f, new Vector3(0, 0, 1)));
